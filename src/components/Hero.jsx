...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-[100svh] w-full bg-white text-[#111111] overflow-hidden flex flex-col pt-32 px-6 md:px-12 lg:px-16 pb-12"
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mt-16 md:mt-24 flex-1 gap-12 md:gap-6 relative z-10">
        ...
        <motion.div 
          ...
          className="w-full md:w-[30%] flex flex-col items-start gap-8"
        >
          {/* Custom Arrow Icon */}
        ...
        <motion.div 
          ...
          className="w-full md:w-[35%] flex justify-center h-[50vh] md:h-auto md:absolute md:left-1/2 md:-translate-x-1/2 md:bottom-0 md:top-8"
        >
          <img 
            src="https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?q=80&w=1000&auto=format&fit=crop" 
            alt="Workspace" 
            className="w-full md:w-[280px] lg:w-[360px] h-full object-cover rounded-xl grayscale opacity-90 object-center"
          />
        </motion.div>
